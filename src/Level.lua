...
function Level:init()
    ...
    function beginContact(a, b, coll)
        ...
        -- Handle collision between obstacle and alien
        ...
        -- Handle collision between player and alien
    ...
    -- The following functions are sample definitions; they are not used in this demo
